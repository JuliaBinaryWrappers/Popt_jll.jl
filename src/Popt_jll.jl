...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Popt_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e80236cf-ab1d-5f5d-8534-1d1285fe49e8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Popt", artifacts_toml) for e in artifacts["Popt"]]
...
if best_platform === nothing
    @debug("Unable to load Popt; unsupported platform $(triplet(platform_key_abi()))")
else
